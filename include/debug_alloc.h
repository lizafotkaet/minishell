...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/21 04:16:25 by liza              #+#    #+#             */
/*   Updated: 2026/03/22 20:45:53 by ebarbash         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
	This header was only needed for memory allocation
	debugging and I also used macros for memory allocation
	which turned out to be banned by the Norm :3
*/
...
// 	((type *)debug_calloc((count),
// 		 sizeof(type), #type, __FILE__, __LINE__))
// #  define FREE(ptr) \
// 	debug_free((ptr), __FILE__, __LINE__)
// #  define SET_ALLOC_FAIL(n) \
// 	do { g_alloc_counter = 0;
// 			 g_fail_on_alloc = (n); } while (0)
// #  define RESET_ALLOC_FAIL() \
// 	do { g_alloc_counter = 0;
// 			 g_fail_on_alloc = 0; } while (0)
// # else
// #  define ALLOC(type, count) \
